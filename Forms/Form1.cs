...
namespace Buy_Or_Sail
{
    public partial class Form1 : Form
    {
        ...
        public Classes.Table DB { get { return db; } }
        public ComboBox Theme_Check { get { return Theme_check; } }

        public Form1(Classes.Table DB)
        {
            InitializeComponent();
        ...
        public void add_user(string Nick)
        {
            ...
            {
                if (nick != "andrey") pictureBox8.Image = new Bitmap(Buy_Or_Sail.Properties.Resources.moderate);
                pictureBox8.Visible = true;
            }
            else
                if (!db.Users_to_admin.Contains(db.Users[nick])) pictureBox9.Visible = true; else label5.Visible = true;
        ...
        {
            Statistic form = new Statistic(this);
            form.Show();
        }
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            if (!db_tags.ContainsKey(tag_check.Text) || !db_tags[tag_check.Text].Contains(tag_box.Text)) return;
